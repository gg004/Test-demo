...
const SnackBar = () => {
  ...
  return show ? (
    <div style={ { zIndex: 10000000 } } id="mkd-toast" className="fixed top-5 right-5 flex items-center w-full max-w-xs p-4 text-gray-500 bg-slate-100 rounded-lg shadow dark:text-gray-400" role="alert">
