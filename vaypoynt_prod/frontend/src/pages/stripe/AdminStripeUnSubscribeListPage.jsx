...
const AdminStripeUnSubscribeListPage = () => {
  ...
  async function getData ( pageNum, limitNum ) {
    try {
      const result = await sdk.getUnscribers( { page: pageNum, limit: limitNum } );
    ...
    <>
      ...
      <div className="overflow-x-auto  p-5 bg-white shadow rounded">
        <div className="mb-3 text-center justify-between w-full flex  ">
          <h4 className="text-2xl font-medium">Pending Cancel Requests </h4>
        </div>
...
export default AdminStripeUnSubscribeListPage;
