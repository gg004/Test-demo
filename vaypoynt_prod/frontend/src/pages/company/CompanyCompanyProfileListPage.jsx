...
const CompanyCompanyProfileListPage = () => {
    ...
    <>
      ...
      <div className="overflow-x-auto  p-5 bg-white shadow rounded">
        <div className="mb-3 text-center justify-between w-full flex  ">
          ...
          <div className="flex">
            <AddButton link={ "/company/add-company_profile" } />
                        ...
                        return (
                          ...
                          >
                            <button
                              className="text-xs"
                              onClick={ () => {
                                navigate( "/company/edit-company_profile/" + row.id, {
                                  state: row,
                                } );
                              } }
                            >
                            ...
                            <button
                              ...
                              onClick={ () => {
                                navigate( "/company/view-company_profile/" + row.id, {
                                  state: row,
                                } );
                              } }
                            >
...
export default CompanyCompanyProfileListPage;
