...
const CompanyDeskHotellingListPage = () => {
    ...
    <>
      ...
      <div className="overflow-x-auto  p-5 bg-white shadow rounded">
        <div className="mb-3 text-center justify-between w-full flex  ">
          ...
          <div className="flex">
            <AddButton link={ "/company/add-desk_hotelling" } />
                        ...
                        return (
                          ...
                          >
                            <button
                              className="text-xs"
                              onClick={ () => {
                                navigate( "/company/edit-desk_hotelling/" + row.id, {
                                  state: row,
                                } );
                              } }
                            >
                            ...
                            <button
                              ...
                              onClick={ () => {
                                navigate( "/company/view-desk_hotelling/" + row.id, {
                                  state: row,
                                } );
                              } }
                            >
...
export default CompanyDeskHotellingListPage;
