...
const CompanyEmployeeProfileListPage = () => {
  ...
  return (
    <>
      ...
      >
        <h4 className="text-2xl font-medium">EmployeeProfile Search</h4>
      ...
      <div className="overflow-x-auto  p-5 bg-white shadow rounded">
        <div className="mb-3 text-center justify-between w-full flex  ">
          <h4 className="text-2xl font-medium">EmployeeProfile</h4>
          <div className="flex">
            <AddButton link={ "/company/add-employee_profile" } />
                        ...
                        return (
                          ...
                          >
                            <button
                              className="text-xs"
                              onClick={ () => {
                                navigate( "/company/edit-employee_profile/" + row.id, {
                                  state: row,
                                } );
                              } }
                            >
                            ...
                            <button
                              ...
                              onClick={ () => {
                                navigate( "/company/view-employee_profile/" + row.id, {
                                  state: row,
                                } );
                              } }
                            >
...
export default CompanyEmployeeProfileListPage;
