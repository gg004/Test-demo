...
const EmployeeStripeOrderListPage = () => {
    ...
    <>
      ...
      <div className="overflow-x-auto  p-5 bg-white shadow rounded">
        <div className="mb-3 text-center justify-between w-full flex  ">
          ...
          <div className="flex">
            <AddButton link={ "/employee/add-stripe_order" } />
                        ...
                        return (
                          ...
                          >
                            <button
                              className="text-xs"
                              onClick={ () => {
                                navigate( "/employee/edit-stripe_order/" + row.id, {
                                  state: row,
                                } );
                              } }
                            >
                            ...
                            <button
                              ...
                              onClick={ () => {
                                navigate( "/employee/view-stripe_order/" + row.id, {
                                  state: row,
                                } );
                              } }
                            >
...
export default EmployeeStripeOrderListPage;
