...
const EmployeeDepartmentListPage = () => {
  ...
  return (
    <>
      ...
      >
        <h4 className="text-2xl font-medium">Department Search</h4>
      ...
      <div className="overflow-x-auto  p-5 bg-white shadow rounded">
        <div className="mb-3 text-center justify-between w-full flex  ">
          <h4 className="text-2xl font-medium">Department</h4>
          <div className="flex">
            <AddButton link={ "/employee/add-department" } />
                        ...
                        return (
                          ...
                          >
                            <button
                              className="text-xs"
                              onClick={ () => {
                                navigate( "/employee/edit-department/" + row.id, {
                                  state: row,
                                } );
                              } }
                            >
                            ...
                            <button
                              ...
                              onClick={ () => {
                                navigate( "/employee/view-department/" + row.id, {
                                  state: row,
                                } );
                              } }
                            >
...
export default EmployeeDepartmentListPage;
