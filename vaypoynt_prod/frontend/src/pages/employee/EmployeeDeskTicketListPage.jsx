...
const EmployeeDeskTicketListPage = () => {
  ...
  return (
    <>
      ...
      >
        <h4 className="text-2xl font-medium">DeskTicket Search</h4>
      ...
      <div className="overflow-x-auto  p-5 bg-white shadow rounded">
        <div className="mb-3 text-center justify-between w-full flex  ">
          <h4 className="text-2xl font-medium">DeskTicket</h4>
          <div className="flex">
            <AddButton link={ "/employee/add-desk_ticket" } />
                        ...
                        return (
                          ...
                          >
                            <button
                              className="text-xs"
                              onClick={ () => {
                                navigate( "/employee/edit-desk_ticket/" + row.id, {
                                  state: row,
                                } );
                              } }
                            >
                            ...
                            <button
                              ...
                              onClick={ () => {
                                navigate( "/employee/view-desk_ticket/" + row.id, {
                                  state: row,
                                } );
                              } }
                            >
...
export default EmployeeDeskTicketListPage;
