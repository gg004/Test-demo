...
const EmployeeCompanyProfileListPage = () => {
  ...
  const onSubmit = ( data ) => {
    ...
    let company_logo = getNonNullValue( data.company_logo );
    let address = getNonNullValue( data.address );
    let comapny_name = getNonNullValue( data.comapny_name );
    let filter = {
      id,
  ...
  return (
    <>
      ...
      >
        <h4 className="text-2xl font-medium">CompanyProfile Search</h4>
      ...
      <div className="overflow-x-auto  p-5 bg-white shadow rounded">
        <div className="mb-3 text-center justify-between w-full flex  ">
          <h4 className="text-2xl font-medium">CompanyProfile</h4>
          <div className="flex">
            <AddButton link={ "/employee/add-company_profile" } />
                        ...
                        return (
                          ...
                          >
                            <button
                              className="text-xs"
                              onClick={ () => {
                                navigate( "/employee/edit-company_profile/" + row.id, {
                                  state: row,
                                } );
                              } }
                            >
                            ...
                            <button
                              ...
                              onClick={ () => {
                                navigate( "/employee/view-company_profile/" + row.id, {
                                  state: row,
                                } );
                              } }
                            >
...
export default EmployeeCompanyProfileListPage;
