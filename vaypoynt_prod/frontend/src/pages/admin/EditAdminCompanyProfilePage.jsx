...
const EditAdminCompanyProfilePage = () => {
  ...
  const [ user_id, setUserId ] = useState( '' ); const [ first_name, setFirstName ] = useState( '' ); const [ last_name, setLastName ] = useState( '' ); const [ email, setEmail ] = useState( '' ); const [ company_logo, setCompanyLogo ] = useState( '' ); const [ address, setAddress ] = useState( '' ); const [ company_name, setCompanyName ] = useState( '' );
    ...
    ( async function () {
      try {
        ...
        if ( !result.error ) {
          ...
          setValue( 'company_name', result.model.company_name );
  ...
  const onSubmit = async ( data ) => {
    try {
      ...
      if ( !result.error ) {
        ...
        navigate( "/admin/company_profile" );
      } else {
...
export default EditAdminCompanyProfilePage;
